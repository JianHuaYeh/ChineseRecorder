 ...
 * @author jhyeh
 */
public class SubjectExtract extends Thread {
    private String fname;
    
    public SubjectExtract(String s) {
        this.fname = s;
    }
    
    public void run() {
        ArrayList al = subjectByLine();
    ...
    private ArrayList subjectByLine() {
        ...
        try {
            ...
            while ((line=br.readLine()) != null) {
                ...
                // skip these lines
                String[] skips = {"SUBJECT [I! ].+", "THE CHINESE REC.+", ".+cont.", "[0-9][0-9][0-9]"};
    ...
    public static void main(String[] args) {
        SubjectExtract se = new SubjectExtract(args[0]);
        se.start();
    }
